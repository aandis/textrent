	...
	<div class="header">
		<div class="container">
			<div class="sixteen columns">
				<div class="logo"><a href="http://www.textrent.in/index.html"><img src="http://www.textrent.in/img/logo.png"/></a></div>
					<div id="line">
						<ul>
				...
				<div class="one-third column">
					<a class="cirlink" href="http://keralauniv.textrent.in/">
						<div class="circle">
							<h2 class="textcolor">Kerela <br>University
							</h2>
						</div>
					</a>
				</div>
				<div class="one-third column">
					<a class="cirlink" href="http://bitspilani.textrent.in/">
						<div class="circle">
							<h2 class="textcolor">IIT<br> ROPAR
							</h2>
						</div>
					</a>
				</div>
				<div class="one-third column">
					<a class="cirlink" href="http://www.textrent.in/hiring.html#title">
						<div class="circle">
							<h2 class="textcolor">BITS<br> PILANI
							</h2>
						</div>
					</a>
				</div>
		<div class="sixteen columns">
          <div id="buy"><h1>Why buy textbooks, when you can <span style="color:#FF4812">Rent</span>?</h1></div>
          <ul id="pref">
